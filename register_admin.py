...
server_url = "http://localhost:8008"  # Update if using a different server URL
shared_secret = "fGXb_or389&UdRj9oR=QFBBH_0FlrTkY1U9o6i=zc:LW*6f+#p"  # Replace with your shared secret
